package com.example.export_import.config;


import com.example.export_import.util.StringUtils;
import com.example.export_import.util.YamlUtil;
...
//        return getConfig("ruoyi.profile") + "download/";
    ...
    {
        return getConfig("ruoyi.profile") + "reportFile/";
    }
    public static String getReportPath()
    {
        return getConfig("ruoyi.profile") + "report/";
    }
}
